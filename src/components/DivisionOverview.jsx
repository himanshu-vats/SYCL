  ...
  return (
    <div>
      <style>{`
        ...
        .do-split-grid { display: grid; grid-template-columns: 1fr; gap: 16px; margin-bottom: 20px; align-items: start; }
        .do-col { min-width: 0; }
        ...
        @media (min-width: 700px) {
          .do-split-grid { grid-template-columns: 1fr 1fr; }
        }
      ...
      {top4.length > 0 ? (
        <div className="do-split-grid">
          ...
          {/* Right: Next Matches + Recent Results stacked */}
          <div className="do-col">
            <div className="section-label">Next Matches</div>
            <div className="do-card">
              {nextMatches.length === 0 && (
                <div style={{ fontSize: 12, color: 'var(--text-muted)', padding: '12px 0', textAlign: 'center' }}>No upcoming matches</div>
              )}
              {nextMatches.map(m => (
            ...
            <div className="section-label" style={{ marginTop: 16 }}>Recent Results</div>
            <div className="do-card">
              {recentResults.length === 0 && (
                <div style={{ fontSize: 12, color: 'var(--text-muted)', padding: '12px 0', textAlign: 'center' }}>No results yet</div>
              )}
              {recentResults.map(m => {
        ...
        /* No standings yet — show matches/results side by side */
